...
# b1 = Button(root, bg='green', fg='white', activebackground='white', activeforeground='green',
#             text='Capture Image', relief=RIDGE, height=20, width=3, command=captureImage)
# b1.pack(side=LEFT, padx=60, pady=5)
# b2 = Button(root, fg='white', bg='red', activebackground='white', activeforeground='red',
#             text='EXIT ❌ ', relief=RIDGE, height=200, width=20, command=exitWindow)
